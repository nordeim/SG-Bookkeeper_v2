...
This table model is well-defined for displaying product summaries.
...
*   **`on_save_product`**: Collects data, creates `ProductCreateData` or `ProductUpdateData` DTO (passing `ProductTypeEnum` member for `product_type`).
